...
oscars_demographics_clean <- oscars_demographics %>%
  mutate(name = map(name, ~ fix_winner_name(.)))

saveRDS(oscars_demographics_clean, "Oscars_Local/oscars_demographics_clean.rds")